...
from Test2.base_service import BaseService
...
if __name__ == '__main__':
    ...
    date_list = [{"orderDate": "2022-04-23 13:08:34", "number": 33}]
    resp = ms.add(date_list)
    print("resp=", resp)
    print(type(resp))
    print("-" * 50)
    resp = ms.get_order_setting_by_month("2022.4")
    print("resp=", resp)
    print(type(resp))
    print("-" * 50)
    info = {"orderDate": "2022-05-11 12:00:00", "number": 777}
    resp = ms.edit_number_by_date(info)
    print("resp=", resp)
    print(type(resp))
    print("-" * 50)
